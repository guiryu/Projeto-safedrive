...
void relatorio(int quantidade_linhas, float velocidades[][], float sensores_frontais[][] ,float sensores_laterais[][], float processamento[][] , int status[][]);
...
void analise_risco_frontal(int quantidade_linhas, float velocidades[][], float processamento[][], int status[][]);
...
void distancia_segura(int sensi, int atrito, int colunas, int quantidade, float vel[][colunas], float processamento[][colunas]){
    ...
    void analise_risco_frontal(int quantidade_linhas, float velocidades[][2], float processamento[][3], int status[][3]){
...
void assistente_faixa(int quantidade_linhas, float velocidades[][2], float sensores[][2], int status[][3]){
    ...
    void relatorio (int quantidade_linhas, float velocidades[MAX_AMOSTRAS][2], float sensores_frontais[MAX_AMOSTRAS][3] ,float sensores_laterais[MAX_AMOSTRAS][2], float processamento[MAX_AMOSTRAS][2] , int status[MAX_AMOSTRAS][3]){
